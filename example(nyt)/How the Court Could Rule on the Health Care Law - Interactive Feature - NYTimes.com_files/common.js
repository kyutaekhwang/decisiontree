...
/*
 * $Id: common.js 154007 2016-05-24 15:45:21Z krishna.donepudi $
...
//If SF page has GLOBAL cookie set and has International Subsection, then redirect page to International version of Sectionfront
(function (jQuery) {
    'use strict';
    ...
    if (isSectionFrontPage && hasGlobalEditionOfPage) {
        if (isGlobalEdition && (!(isInternationalSubSection))) {
            window.location.href = currentURL.replace(currentSection, currentSection + "/international");
        }
    }
}(NYTD.jQuery));
